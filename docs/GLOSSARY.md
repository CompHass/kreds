...
| Term | Definition | Context / Requirements |
|------|------------|----------------------|
| **Kreds** | The internal currency unit used in the app. Stored as integer minor units (never floats). | All financial operations. LEDG-01, LEDG-02 |
