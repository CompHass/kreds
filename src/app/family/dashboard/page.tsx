...
/**
 * /family/dashboard is kept only as a redirect target — every "home"/"Jardim"
 * link across the app (BottomNav, audit, wishes, children pages, guardian
 * login) still points here. The real guardian panel is
 * /family/[familyId]/tasks (ParentPanelView, Fases 5-6).
 */
